...
public interface WikiDataService {
     ...
     * @throws DataAccessException
     */
    GroupMap getGroupMapUser(String userLogin) throws DataAccessException;
     ...
     * @throws DataAccessException Thrown if any error occurs during method execution.
     */
    List<RoleMap> getRoleMapByRole(String authority) throws DataAccessException;
     ...
     * @throws DataAccessException Thrown if any error occurs during method execution.
     */
    List<RoleMap> getRoleMapByRole(String authority, boolean includeInheritedRoles) throws DataAccessException;
     ...
     * @throws DataAccessException Thrown if any error occurs during method execution.
     */
    List<RecentChange> getUserContributions(String virtualWiki, String userString, Pagination pagination,
            boolean descending) throws DataAccessException;
     ...
     * @throws DataAccessException Thrown if any error occurs during method execution.
     */
    Map<Integer, String> lookupTopicByType(String virtualWiki, TopicType topicType1, TopicType topicType2,
            Integer namespaceId, Pagination pagination) throws DataAccessException;
    ...
    WikiUser lookupPwResetChallengeData(String username) throws DataAccessException;
     ...
     * @throws WikiException Thrown if the topic information is invalid.
     */
    void moveTopic(Topic fromTopic, String destination, WikiUser user, String ipAddress, String moveComment)
     ...
     * @throws DataAccessException Thrown if any error occurs during method execution.
     */
    void purgeTopicVersion(Topic topic, int topicVersionId, WikiUser user, String ipAddress)
            throws DataAccessException, WikiException;
    ...
    void updatePwResetChallengeData(WikiUser user) throws DataAccessException;
     ...
     */
    void writeConfiguration(Map<String, String> configuration) throws DataAccessException, WikiException;
     ...
     */
    void writeFile(WikiFile wikiFile, WikiFileVersion wikiFileVersion, ImageData imageData)
            throws DataAccessException, WikiException;
     ...
     * @throws WikiException Thrown if the namespace information is invalid.
     */
    void writeNamespaceTranslations(List<Namespace> namespaces, String virtualWiki)
            throws DataAccessException, WikiException;
     ...
     * @throws WikiException Thrown if the topic information is invalid.
     */
    void writeTopic(Topic topic, TopicVersion topicVersion, Map<String, String> categories, List<String> links)
            throws DataAccessException, WikiException;
     ...
     */
    void writeTopicVersions(Topic topic, List<TopicVersion> topicVersions) throws DataAccessException, WikiException;
     ...
     */
    void writeUserBlock(UserBlock userBlock) throws DataAccessException, WikiException;
     ...
     */
    void writeWatchlistEntry(Watchlist watchlist, String virtualWiki, String topicName, int userId)
            throws DataAccessException, WikiException;
     ...
     */
    void writeUserPreferenceDefault(String userPreferenceKey, String userPreferenceDefaultValue,
            String userPreferenceGroupKey, int sequenceNr) throws DataAccessException;
     ...
     * @throws DataAccessException Thrown if any error occurs during method execution.
     */
    void insertImage(ImageData imageData, boolean resized) throws DataAccessException;
     ...
     * @throws DataAccessException Thrown if any error occurs during method execution.
     */
    ImageData getImageInfo(int fileId, int resized) throws DataAccessException;
     ...
     * @throws DataAccessException Thrown if any error occurs during method execution.
     */
    ImageData getImageData(int fileId, int resized) throws DataAccessException;
     ...
     * @throws DataAccessException Thrown if any error occurs during method execution.
     */
    ImageData getImageVersionData(int fileVersionId, int resized) throws DataAccessException;
