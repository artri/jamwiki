...
public class WikiUtil {
    ...
    private static final Logger logger = LoggerFactory.getLogger(WikiUtil.class);
    ...
    public static boolean isUpgrade() {
        ...
        WikiVersion currentVersion = new WikiVersion(WikiBase.CURRENT_WIKI_VERSION);
     ...
     *  "txt", not ".txt".
     */
    public static List<String> retrieveUploadFileList() {
