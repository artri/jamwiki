...
public class SetupServlet extends JAMWikiServlet {
    ...
    private static final Logger logger = LoggerFactory.getLogger(SetupServlet.class);
    ...
    private boolean initialize(HttpServletRequest request, ModelAndView next, WikiPageInfo pageInfo) throws Exception {
        ...
        Environment.setValue(Environment.PROP_BASE_WIKI_VERSION, WikiBase.CURRENT_WIKI_VERSION);
    ...
    private void view(HttpServletRequest request, ModelAndView next, WikiPageInfo pageInfo) throws Exception {
        ...
        pageInfo.setPageTitle(new WikiMessage("setup.title", WikiBase.CURRENT_WIKI_VERSION));
        ...
        WikiMessage logMessage = new WikiMessage("setup.help.logfile", WikiBase.LOGGING_CONFIGURATION_FILE_PATH);
